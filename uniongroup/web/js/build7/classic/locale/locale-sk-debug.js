...
Ext.onReady(function() {
    ...
    if (Ext.Date) {
        Ext.Date.monthNames = ["JanuÃ¡r", "FebruÃ¡r", "Marec", "AprÃ­l", "MÃ¡j", "JÃºn", "JÃºl", "August", "September", "OktÃ³ber", "November", "December"];

        Ext.Date.dayNames = ["NedeÄ¾a", "Pondelok", "Utorok", "Streda", "Å tvrtok", "Piatok", "Sobota"];
    }
...
Ext.define("Ext.locale.sk.grid.plugin.DragDrop", {
    ...
    dragText: "{0} oznaÄenÃ½ch riadkov"
});

Ext.define("Ext.locale.sk.tab.Tab", {
    override: "Ext.tab.Tab",
    closeText: "ZavrieÅ¥ tÃºto zÃ¡loÅ¾ku"
});

Ext.define("Ext.locale.sk.form.field.Base", {
    override: "Ext.form.field.Base",
    invalidText: "Hodnota v tomto poli je nesprÃ¡vna"
});
...
Ext.define("Ext.locale.sk.picker.Date", {
    ...
    prevText: 'PredchÃ¡dzajÃºci mesiac (Control+DoÄ¾ava)',
...
Ext.define("Ext.locale.sk.form.field.VTypes", {
    ...
    emailText: 'Toto pole musÃ­ byÅ¥ e-mailovÃ¡ adresa vo formÃ¡te "user@example.com"',
    urlText: 'Toto pole musÃ­ byÅ¥ URL vo formÃ¡te "http:/' + '/www.example.com"',
...
Ext.define("Ext.locale.sk.grid.header.Container", {
    ...
    lockText: 'ZamknÃºÅ¥ stÄºpec',
    unlockText: 'OdomknÃºÅ¥ stÄºpec',
    columnsText: 'StÄºpce'
});
